...
curl -XPUT es-cdaq:9200/runindex_${subsystem}_${newdate}?pretty -d'{"settings":{"index":{"number_of_shards" : "8","number_of_replicas" : "2","codec" : "best_compression"},"mapper" : { "dynamic" : "false"}, "translog" : {"durability" : "async","flush_threshold_size":"4g"},"analysis" : {"analyzer" : {"default" : {"type" : "keyword"}}}}}'
curl -XPUT es-cdaq:9200/merging_${subsystem}_${newdate}?pretty  -d'{"settings":{"index":{"number_of_shards" : "8","number_of_replicas" : "1","codec" : "best_compression"},"mapper" : { "dynamic" : "false"}, "translog" : {"durability" : "async","flush_threshold_size":"4g"},"analysis" : {"analyzer" : {"default" : {"type" : "keyword"}}}}}'
curl -XPUT es-cdaq:9200/boxinfo_${subsystem}_${newdate}?pretty  -d'{"settings":{"index":{"number_of_shards" : "8","number_of_replicas" : "1","codec" : "best_compression"},"mapper" : { "dynamic" : "false"}, "translog" : {"durability" : "async","flush_threshold_size":"4g"},"analysis" : {"analyzer" : {"default" : {"type" : "keyword"}}}}}'
